<!DOCTYPE html>
    ...
    <div class="navbar">
        <a href="index.html">Trang Chủ</a>
            ...
            ?>
                <div class="home__container ">
                    <div class="home__data">
                        <h1 class="home__data-title">BÁN ĐẢO SƠN TRÀ</h1>
                    </div>
            ...
            <section class="about section" id="about">
                <div class="about__container">
                    <div class="about__data">
                        <h2 class="section__title about__title">BÁN ĐẢO SƠN TRÀ</h2>
                        <?php 
                            include 'connect.php';
                            $id = 3; 
                ...
                <div class="explore__container">
                    <div class="experience__container container grid">
                        ...
                        ?>
                            ...
                            <div class="experience__data">
                                <h2 class="experience__number">Đỉnh Bàn Cờ Tiên</h2>
                                <?php 
                            include 'connect.php';
                            $id = 3; 
                            $sql = "SELECT id, des_ex1, des_ex2, des_ex3 FROM location WHERE id = ?";
                        ...
                        ?>
                            ...
                            <div class="experience__data">
                                <h2 class="experience__number">Các Bãi Biển Và Hoạt Động</h2>
                                <?php 
                            include 'connect.php';
                            $id = 3; 
                            $sql = "SELECT id, des_ex1, des_ex2, des_ex3 FROM location WHERE id = ?";
                    ...
                    <div id="carouselExampleIndicators" class="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <img src="img/ex_SonTra1.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="img/ex_SonTra2.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="img/ex_SonTra3.png" class="d-block w-100" alt="...">
                            </div>
                        </div>
            ...
            <section>
                <h2 style="text-align: center;">Hướng dẫn đường đi đến Bán Đảo Sơn Trà</h2>
                <div style="text-align: center;">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d61325.106798531684!2d108.23440995799201!3d16.126652330983745!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31423d72d1be522d%3A0x1e7339a6534e4e7!2zQsOhbiDEkeG6o28gU8ahbiBUcsOg!5e0!3m2!1svi!2s!4v1717901783469!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
            </section>
            <section>
